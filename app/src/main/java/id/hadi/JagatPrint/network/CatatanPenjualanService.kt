package id.hadi.catatanpenjualan.network

import id.hadi.catatanpenjualan.activity.data_barang.data.ResultDataBarang
import id.hadi.catatanpenjualan.activity.login.data.ResultLogin
import id.hadi.catatanpenjualan.activity.penjualan.data.ResultKeranjang
import id.hadi.catatanpenjualan.activity.penjualan.data.ResultSearchBarang
import id.hadi.catatanpenjualan.activity.report.detail.data.ResultItemKeranjang
import id.hadi.catatanpenjualan.response.ResultSimple
